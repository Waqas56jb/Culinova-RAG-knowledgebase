...
async function getEntryDetail(entryId) {
  ...
  // the CULINOVA category standard that governs this equipment (its required utilities, fixed values,
  // and what is still pending on the discipline rule tables). Best-effort — a resolver hiccup must
  // never break the whole detail payload.
